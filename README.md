...
> 📖 **For detailed request/response specifications, see the `API_REFERENCE.md` file in the repository root.**

> ⚠️ **IMPORTANT:** All API endpoint implementations **MUST** exactly match the specifications defined in `API_REFERENCE.md`. This includes:
>
...
- **`API_REFERENCE.md`** - Detailed endpoint documentation with request/response examples
- **`SUBMISSION_GUIDE.md`** - Assignment submission requirements and deadlines
